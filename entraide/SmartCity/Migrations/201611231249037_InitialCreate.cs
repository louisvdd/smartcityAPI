namespace SmartCity.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        CommentOfService_Id = c.Long(),
                        ServiceDone_Id = c.Long(nullable: false),
                        UserDoService_Id = c.String(nullable: false, maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Comments", t => t.CommentOfService_Id)
                .ForeignKey("dbo.Services", t => t.ServiceDone_Id, cascadeDelete: true)
                .ForeignKey("dbo.AspNetUsers", t => t.UserDoService_Id, cascadeDelete: true)
                .Index(t => t.CommentOfService_Id)
                .Index(t => t.ServiceDone_Id)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.DoServices", "ServiceDone_Id", "dbo.Services");
            ...
            DropForeignKey("dbo.DoServices", "CommentOfService_Id", "dbo.Comments");
            ...
            DropIndex("dbo.DoServices", new[] { "ServiceDone_Id" });
            DropIndex("dbo.DoServices", new[] { "CommentOfService_Id" });
